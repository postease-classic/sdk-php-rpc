 ...
 * Preparation
 * ------------
 * require_once 'your_client_path/Pec/Pec.php';
 * $pe = new Pec();
 * $pe->connect('https://your-postease-server.com/api/php/pesf_rpc.php');
...
class _PHPRPC_Client {
    ...
    function connect($serverURL, $username = NULL, $password = NULL) {
        $this->_disconnect();
...
if (function_exists("overload") && version_compare(phpversion(), "5", "<")) {
    eval('
    class Pec extends _PHPRPC_Client {
